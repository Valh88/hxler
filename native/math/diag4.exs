...
r = Hxler.Math.diag_roundtrip()
IO.puts("diag_roundtrip         = #{inspect(r)}  (want {:ok, 42})")
IO.puts("diag_obj_null(a)       = #{inspect(Hxler.Math.diag_obj_null(a))}  (want false, obj preserved)")
